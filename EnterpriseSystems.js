...
import { Target, FileText, LayoutGrid, ArrowRight } from 'lucide-react';
...
export function EnterpriseSystems({ onCapSelect }) {
  return (
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-3">
          {SYSTEMS.map((item) => (
            <button 
              ...
              className="group text-left rounded-[2.5rem] border border-slate-200 bg-white p-8 hover:border-blue-300 hover:shadow-xl hover:shadow-blue-600/5 transition-all"
            >
